      ...
      <section className="py-60 -mt-10 px-8 z-10 relative">
                ...
                style={{paddingLeft: '100px', paddingRight: '100px'}}>
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-8 text-center :">
                      ...
                      <FaTasks className="text-4xl text-black items-start justify-between" />
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-8 text-center">
                      ...
                      <FaChartLine className="text-4xl text-black" />
        ...
        <div className="flex items-center justify-center w-[75px] h-[75px] mb-4 mx-auto ">
          <FaRoute className="text-4xl text-black" />
        </div>
