...
const Services = () => {
  const services = [
    {
      icon: <FaComments className="text-5xl text-black mb-4" />,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <a href="#" className="bg-gray-100 text-black px-3 py-2 rounded-full inline-block font-semibold text-center">
                ↗
              </a>
            </div>
          ))}
