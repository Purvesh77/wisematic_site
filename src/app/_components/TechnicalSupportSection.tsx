...
const cards = [
  {
    ...
    description: "At Wisematic, our team is focussed on working with you to achieve success."
  },
  {
  ...
  return (
    <div className="relative flex flex-col items-center text-center py-40">
      ...
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="w-[800px] h-[600px] bg-gradient-to-r from-emerald-400 to-indigo-600 rounded-full blur-3xl opacity-30"></div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-16 max-w-6xl">
        {cards.map((card, index) => (
          <div key={index} className="bg-white rounded-xl shadow-lg p-10 flex flex-col items-center w-96 h-80">
            {card.icon}
