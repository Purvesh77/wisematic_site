    ...
    <div className="bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row items-start justify-between">
        <div className="w-full md:w-1/2 text-left space-y-4 pl-60">
          <h1 className="text-2xl text-gray-300">DATA ANALYTICS</h1>
        ...
        <div className="w-full md:w-1/2 text-left mr-20 pr-20">
          <p className="text-lg text-gray-400 mb-4" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>
            At Wisematic, we transform raw data into actionable insights that drive business growth. Our expert team leverages advanced techniques to deliver predictive modeling, data visualization, and customer segmentation solutions tailored to your specific needs.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pr-10">
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Data-Driven Success</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>End-to-End Expertise</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Measurable Results</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Cutting-Edge Technology</span>
            </div>
          </div>
        </div>
      </div>
