    ...
    <div className="bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row items-start justify-between">
        <div className="w-full md:w-1/2 text-left space-y-4 pl-60">
          <h1 className="text-2xl text-gray-300">DIGITAL MARKETING</h1>
        ...
        <div className="w-full md:w-1/2 text-left mr-20 pr-20">
          <p className="text-lg text-gray-400 mb-4" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>
            In today’s digital landscape, a strong online presence is essential for businesses of all sizes. Wisematic offers a comprehensive suite of digital marketing services designed to help you reach your target audience, drive traffic, and achieve your business goals.
          </p>
          <p className="text-lg text-gray-400 mb-4" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>
            Let’s work together to enhance your online presence and unlock your growth. Our team of experts will work closely with you to understand your business goals and challenges and develop a customized strategy to help you achieve them.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pr-10">
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Data-Driven Strategies</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Customer Focus</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Comprehensive Service Offerings</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Expert Team</span>
            </div>
          </div>
        </div>
      </div>
