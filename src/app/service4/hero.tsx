    ...
    <div className="bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row items-start justify-between">
        <div className="w-full md:w-1/2 text-left space-y-4 pl-60">
          <h1 className="text-2xl text-gray-300">SOFTWARE as a SERVICE</h1>
        ...
        <div className="w-full md:w-1/2 text-left mr-20 pr-20">
          <p className="text-lg text-gray-400 mb-4" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>
            Struggling to connect with your audience and drive sales? Our SAAS empowers you to create personalized customer journeys, automate marketing tasks, and measure campaign performance with precision.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pr-10">
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Enhanced Productivity</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Exceptional Customer Support</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Revolutionary Design</span>
            </div>
          </div>
        </div>
      </div>
