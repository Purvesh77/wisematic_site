            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pr-10">
              <div className="flex items-center">
                ...
                <span className="text-black text-lg font-bold"
                 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Efficiency Boost</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-black text-lg font-bold"
                 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Data-Driven Insights</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className=" text-lg text-black font-bold"
                 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Competitive Advantage</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className=" text-lg text-black font-bold"
                 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500 }}>Scalability</span>
              </div>
            </div>
